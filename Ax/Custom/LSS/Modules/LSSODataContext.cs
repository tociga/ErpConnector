...
{
    public class LSSODataContext : Resources
    {
        ...
        /// </summary>
        public LSSODataContext(OAuthHelper oAuthHelper, bool enableCrossCompany) : base(new Uri(oAuthHelper.UriString, UriKind.Absolute))
        {
